...
@WebService(endpointInterface = "interface_repository.ICommunicate")
public class StoreProxy implements ICommunicate {
    ...
    private void setupLogger() throws IOException {
        ...
        Handler fileHandler  = new FileHandler("/Users/yaroslav/school/423/Distributed-Systems-Design/SOAP_Supply_Management_System/logs/stores/" + logFile, true);
