...
import UDP.data.DataHandlerUDP;
import UDP.request.RequestDispatcher;
import UDP.request.RequestDispatcherUDP;
import UDP.request.RequestHandler;
import UDP.request.RequestHandlerUDP;
...
import exceptions.*;
import static UDP.request.RequestTypesUDP.*;
...
public class Store {
    public class StoreServerUDP implements Runnable {
        ...
        public StoreServerUDP(int port) {
            this.port = port;
            this.requestHandler = new RequestHandlerUDP(Store.this.locationName);
    ...
    public Store(String locationName, StoreInventory inventory, SalesManager salesManager, Map<String, Integer> portsConfig) {
        super();
