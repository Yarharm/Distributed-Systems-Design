...
public class UserDriver {
    ...
    private static void runConcurrentDriver() throws IOException {
        Scanner myObj = new Scanner(System.in);
    ...
    private static void runManagerClient() throws IOException, NumberFormatException {
        while(true) {
            Scanner myObj = new Scanner(System.in);
            System.out.println("Choose operation:");
    ...
    private static void runCustomerClient() throws IOException {
        while(true) {
            Scanner myObj = new Scanner(System.in);
            System.out.println("Choose operation:");
