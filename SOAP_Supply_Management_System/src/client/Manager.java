...
public class Manager {
    ...
    public void addItem(String managerID, String itemID, String itemName, int quantity, int price) throws MalformedURLException {
        try {
    ...
    public void removeItem(String managerID, String itemID, int quantity) throws MalformedURLException {
    ...
    public void listItemAvailability(String managerID) throws MalformedURLException {
        try {
    ...
    public void setupLogger() throws IOException {
        ...
        String logFile = "/Users/yaroslav/school/423/Distributed-Systems-Design" +
                "/SOAP_Supply_Management_System/logs/clients/managers/" + this.managerID + "_" + creationTime + ".log";
